...
namespace org.abwe.RockMissions.Churches.Migrations
{
    [MigrationNumber(1, "1.12.0")]
    class ChurchGroup : Migration
    {
        public override void Up()
        {
            ...
            RockMigrationHelper.UpdateGroupType("Church", "the structure representing a church person record and other actual persons with a relationship to the church",
                "Church Group", "Contact", "8bf35114-0d72-4d3d-b15d-0ffe241ae81d", false, false, false, "fa fa-church", 0, "", 1, "", "be7a89fa-4815-4258-a9c6-c08c058ee933");

            RockMigrationHelper.UpdateGroupTypeRole("be7a89fa-4815-4258-a9c6-c08c058ee933", "Admin Contact", "8bf35114-0d72-4d3d-b15d-0ffe241ae81d", 0, null, null, "", true, false, true);
            RockMigrationHelper.UpdateGroupTypeRole("be7a89fa-4815-4258-a9c6-c08c058ee933", "Sent Missionary", "1084eb40-3166-46c6-b0b6-1ac9abc6f6e2", 1, null, null, "", true, false, false);
            RockMigrationHelper.UpdateGroupTypeRole("be7a89fa-4815-4258-a9c6-c08c058ee933", "Supported Missionary", "2c923974-af7f-47a3-bc37-74f76d9ff2f7", 2, null, null, "", true, false, false);
            RockMigrationHelper.UpdateGroupTypeRole("be7a89fa-4815-4258-a9c6-c08c058ee933", "Missions Pastor", "bd3fda15-fbc3-4e64-a873-4c5cce7cbe69", 3, null, null, "", true, false, false);
            RockMigrationHelper.UpdateGroupTypeRole("be7a89fa-4815-4258-a9c6-c08c058ee933", "Pastor", "0afb8d1e-e4bd-47cd-911f-3fa6d4a1bee4", 4, null, null, "", true, false, false);
            RockMigrationHelper.UpdateGroupTypeRole("be7a89fa-4815-4258-a9c6-c08c058ee933", "Senior Pastor", "62fd300c-46f3-4c5f-a0f2-07c345477670", 5, null, null, "", true, false, false);
            RockMigrationHelper.UpdateGroupTypeRole("be7a89fa-4815-4258-a9c6-c08c058ee933", "Member", "f000790b-fbee-428a-803d-1f879729ce98", 6, null, null, "", true, false, false);
            RockMigrationHelper.UpdateGroupTypeRole("be7a89fa-4815-4258-a9c6-c08c058ee933", "Attendee", "732edacb-c282-45cd-831f-eec7aa8be961", 7, null, null, "", true, false, false);
