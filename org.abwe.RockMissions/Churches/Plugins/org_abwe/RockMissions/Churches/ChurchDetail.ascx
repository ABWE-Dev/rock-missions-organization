<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ChurchDetail.ascx.cs" Inherits="RockWeb.Plugins.org_abwe.RockMissions.Churches.ChurchDetail"%>
    ...
    <ContentTemplate>
        <asp:Panel ID="pnlDetails" runat="server">
            ...
            <asp:Panel ID="pnlContactList" runat="server" CssClass="panel panel-block">
                <div class="panel-heading">
                    <h1 class="panel-title"><i class="fa fa-users"></i> Church Contacts</h1>
                </div>
                <div class="panel-body">
