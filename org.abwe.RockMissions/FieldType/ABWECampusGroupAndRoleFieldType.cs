...
namespace Rock.Field.Types
{
    ...
    /// Stored as "GroupType.Guid|Campus.Guid|Group.Guid|GroupTypeRole.Guid"
    /// </summary>
    public class ABWECampusGroupAndRoleFieldType : FieldType
    {
        ...
        {
            ABWECampusGroupAndRolePicker editControl = new ABWECampusGroupAndRolePicker { ID = id };
        ...
        {
            ABWECampusGroupAndRolePicker groupAndRolePicker = control as ABWECampusGroupAndRolePicker;
